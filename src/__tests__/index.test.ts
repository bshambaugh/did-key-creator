...
describe("did-key-creator-p256", () => {
  ...
  test("encodeDIDfromHexStringtoCompressed", () => {
    ...
    expect(
      encodeDIDfromHexString(multicodecName, compressedKey)
    ).toMatchSnapshot();
  });
...
describe("did-key-creator-p384", () => {
  ...
  test("rawKeyInHexfromUncompressed", () => {
    const key =
      "049489d3c65f1f8cb2a9fd40abc48d160e495a862fbbfbfe896ed8878e246f32f85e76129574705f8b61c263cb7f409c9ccba375202fb6997c47ade113056ecade605cc34a86af70961c2b3eca5d3dc824112dcc9f1afed786a0278073aee7566f";
    expect(rawKeyInHexfromUncompressed(key)).toMatchSnapshot();
  });
...
describe("did-key-creator-p521", () => {
  ...
  test("rawKeyInHexfromUncompressed", () => {
    const key =
      "";
    expect(rawKeyInHexfromUncompressed(key)).toMatchSnapshot();
  });
